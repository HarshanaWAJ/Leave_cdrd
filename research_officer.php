         ...
         <div id="main">
            ...
            <div class="main-content container-fluid">
               <div class="page-title">
                  <h3>Research Officer Dashboard</h3>
               </div>
               <br>
                ...
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    ...
                    <?php
                        ...
                        //$sql = "SELECT COUNT(*) AS total_leaves FROM leave_applications_officers WHERE officer_number = '{$_SESSION['officer_number']}'";
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <?php
                      ...
                      $sqlApprovedOfficers = "SELECT COUNT(*) AS total_approved_officers FROM leave_applications_officers 
                                            WHERE status = 'approve' AND status1 = 'approve' AND status2 = 'approve' AND status3 = 'approve' AND officer_number = '$officerId'";
                  ...
                  <div class="d-flex flex-row">
                    ...
                    <?php
                      ...
                      $sqlCanceledOfficers = "SELECT COUNT(*) AS total_canceled_officers FROM leave_applications_officers 
                                              WHERE (status = 'decline' OR status1 = 'decline' OR status2 = 'decline' OR status3 = 'decline') AND officer_number = '$officerId'"; 
