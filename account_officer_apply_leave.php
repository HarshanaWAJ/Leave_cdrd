         ...
         <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
               <div class="sidebar-header" style="height: 50px;margin-top: -30px">
                  <a href="account_officer.php" class="sidebar-link">
               ...
               <div class="sidebar-menu">
                  <ul class="menu">
                     ...
                     <li class="sidebar-item  active">
                        <a href="account_officer_apply_leave.php" class='sidebar-link'>
                        <i class="fa fa-upload text-primary"></i>
                        <span>Apply Leave</span>
                        </a>
                     </li>
                     <li class="sidebar-item ">
                        <a href="account_officer_leave_status.php" class='sidebar-link'>
                        <i class="fa fa-clock text-primary"></i>
                        <span>Leave Status</span>
                        </a>
                     </li>
                     <li class="sidebar-item">
                        <a href="approve_leave_account_officer.php" class="sidebar-link">
    ...
    if (
        ...
        if ($conflictCount > 0) {
            ...
            if ($totalLeaveDays >= 3) {
                ...
                echo "<button class='btn btn-danger' onclick='window.location.href=\"account_officer_special_leave_application.php?totalLeaveDays=$totalLeaveDays&numberOfDays=$numberOfDays\"'>Apply for Special Leave</button>";
                echo "</div>";
            } else {
                ...
                if (is_numeric($numberOfDays)) {
                    ...
                    if ($numberOfDays > $remainingDays) {
                        ...
                        $sql = "INSERT INTO leave_applications_officers (name, leave_type, from_date, to_date, from_time, to_time, number_of_days, officer_number, position, reason)
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                        ...
                        // Bind parameters
                        $stmt->bind_param("ssssssssss", $name, $leaveType, $fromDate, $toDate, $fromTime, $toTime, $numberOfDays, $officer_number, $position, $reason);
