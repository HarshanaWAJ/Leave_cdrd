...
$sql = "SELECT * FROM leave_applications_ero WHERE from_date BETWEEN '$fromDate' AND '$toDate' AND
                                             (status3='decline')";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td>" . htmlspecialchars($row['external_id']) . "</td>";
    ...
    echo "<tr><td colspan='6'>No Decline Applications found</td></tr>";
}
