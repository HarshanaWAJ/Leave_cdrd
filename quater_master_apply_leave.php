         ...
         <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
               <div class="sidebar-header" style="height: 50px;margin-top: -30px">
                  <a href="quater_master.php" class="sidebar-link">
               ...
               <div class="sidebar-menu">
                  <ul class="menu">
                     ...
                     <li class="sidebar-item active">
                        <a href="quater_master_apply_leave.php" class='sidebar-link'>
                        <i class="fa fa-upload text-primary"></i>
                        <span>Apply Leave</span>
                        </a>
                     </li>
                     <li class="sidebar-item ">
                        <a href="quater_master_leave_status.php" class='sidebar-link'>
                        <i class="fa fa-clock text-primary"></i>
                        <span>Leave Status</span>
                        </a>
                     </li>
                     <li class="sidebar-item">
                        <a href="approve_leave_quater_master.php" class="sidebar-link">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        // Check if the session officer ID conflicts with any acting officer ID in the specified period
        ...
        if ($conflictCount > 0) {
            ...
            if ($totalLeaveDays >= 3) {
                ...
                echo "<button class='btn btn-danger' onclick='window.location.href=\"quater_master_special_leave_application.php\"'>Apply for Special Leave</button>";
                echo "</div>";
            } else {
...
?>
                                        ...
                                        $query = "SELECT name, officer_number FROM officers WHERE position IN ('Senior Non Commissioned Officer')";
                                        $result = $conn->query($query);
