...
$sql= "SELECT * FROM external_research_officer WHERE email='$email'";
                                ...
                                <div class="col-md-6 col-12">
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control"  id="first-name-icon" name="ero_id" value="<?php echo $external_id ?>" readonly>
