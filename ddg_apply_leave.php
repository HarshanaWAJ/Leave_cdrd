<?php
    ...
    $query = "SELECT name FROM officers WHERE position IN ('Cheif Controller', 'Cheif Coordinator')";
         ...
         <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
               <div class="sidebar-header" style="height: 50px;margin-top: -30px">
                  <a href="ddg.php" class="sidebar-link">
          ...
          <ul class="menu">
            ...
            <li class="sidebar-item active">
                        <a href="ddg_apply_leave.php" class='sidebar-link'>
                        <i class="fa fa-upload text-primary"></i>
                        <span>Apply Leave</span>
                        </a>
                     </li>
                     <li class="sidebar-item ">
                        <a href="ddg_leave_status.php" class='sidebar-link'>
                        <i class="fa fa-clock text-primary"></i>
                        <span>Leave Status</span>
                        </a>
                     </li>
                     <li class="sidebar-item">
                        <a href="approve_leave_ddg.php" class="sidebar-link">
            ...
            <li class="sidebar-item ">
              <a href="ddg_all_leaves.php" class='sidebar-link'>
...
// Ensure session officer ID is set
$session_officer_id = $_SESSION['officer_number']; // Replace with your actual session variable for officer ID
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        // Check if session officer ID is assigned as acting officer during the specified period
        ...
        if ($conflictCount > 0) {
            ...
            $stmt->execute();
            $stmt->bind_result($totalLeaveDays);
            $stmt->fetch();
            $stmt->close();
            ...
            if ($totalLeaveDays >= 3) {
                ...
                echo "<button class='btn btn-danger' onclick='window.location.href=\"ddg_special_leave_application.php\"'>Apply for Special Leave</button>";
                echo "</div>";
            } else {
...
?>
                                        ...
                                        $query = "SELECT name, officer_number FROM officers WHERE position IN ('Cheif Controller', 'Cheif Coordinator')";
                                        $result = $conn->query($query);
