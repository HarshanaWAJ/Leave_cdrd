                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item active">
                            <a href="inter_apply_leave.html" class="sidebar-link">
                                    ...
                                    <?php
                                            ...
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                ...
                                                if (
                                                    ...
                                                    $internId = $conn->real_escape_string($_POST["internId"]);
                                                    $reason = $conn->real_escape_string($_POST["reason"]);
                                                    $wing = $conn->real_escape_string($_POST["wing"]);

                                                    // Check the total number of leave days for the intern
                                                    //$totalLeaveDaysQuery = "SELECT SUM(number_of_days) AS total_leave_days FROM leave_applications WHERE intern_id = '$internId'";
                                                    //$totalLeaveDaysResult = $conn->query($totalLeaveDaysQuery);
                                                    ...
                                                    $stmt->bind_param("si", $internId, $month); // "si" indicates one string parameter and one integer parameter
                                                    $stmt->execute();
                                                    ...
                                                    if ($totalLeaveDaysResult) {
                                                        ...
                                                        if (isset($_POST["numberOfDays"]) && is_numeric($_POST["numberOfDays"])) {
                                                            ...
                                                            if (($totalLeaveDays + $numberOfDays) > 3) {
                                                                ...
                                                                echo "<button class='btn btn-danger' onclick='window.location.href=\"intern_special_leave_application.php\"'>Apply for Special Leave</button>";
                                                                echo "</div>";
                                                            } else {
                                                                // Perform database insertion using prepared statements for security
                                                                $sql = "INSERT INTO leave_applications (name, leave_type, from_date, to_date, from_time, to_time, number_of_days, intern_id, reason, wing)
                                                                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                                                                ...
                                                                // Bind parameters
                                                                $stmt->bind_param("ssssssssss", $name, $leaveType, $fromDate, $toDate, $fromTime, $toTime, $numberOfDays, $internId, $reason, $wing);
                                        ...
                                        <form class="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="leave-form">
                                                ...
                                                <div class="col-md-6 col-12">
                                                  <div class="form-group has-icon-left">
                                                      ...
                                                      <div class="position-relative">
                                                          <input type="text" class="form-control" placeholder="Intern ID" id="employee-id" name="internId" value= "<?php echo $_SESSION['intern_id'];?>" readonly/>
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control" placeholder="Name"
                                                                id="first-name-icon" name="name" value= "<?php echo $_SESSION['intern_name'];?>" readonly/>
                                                            <div class="form-control-icon">
                                            ...
                                            <div class="col-md-6 col-12">
                                                       ...
                                                       <input type="text" class="form-control" id="basicSelect" name="wing" value="<?php echo $_SESSION['intern_wing']; ?>"  readonly>
