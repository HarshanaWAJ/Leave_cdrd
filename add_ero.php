    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Add External Research Officers</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin.php" class="text-primary">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add External Research Officers</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" class="form-control" placeholder="External Research Officers ID" id="first-name-icon" name="external_id" required>
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        if (
                                            ...
                                            $sql = "INSERT INTO external_research_officer (external_id, name, name_in_full, permanent_address, trade, wing, email, username, password)
                                                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                                            ...
                                            // Bind parameters
                                            $stmt->bind_param("sssssssss", $externalId, $name, $nameInFull, $permanentAddress, $trade, $wing, $email, $username, $hashedPassword);
                                            ...
                                            if ($stmt->execute()) {
                                                echo "<script>
                                                            Swal.fire({
                                                                icon: 'success',
                                                            title: 'Added',
                                                             text: 'External Research Officer added successfully!',
                                                        });
                                                 </script>";
                                            } else {
