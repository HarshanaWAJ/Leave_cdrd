<?php
    ...
    $query = "SELECT name FROM officers WHERE position = 'wing head' AND wing IN ('ARMAMENT & BALLISTIC', 'COMMERCIAL WING')";
                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        $query = "SELECT name, officer_number FROM officers WHERE position = 'wing head' AND wing IN ('ARMAMENT & BALLISTIC', 'COMMERCIAL WING')";
                                        $result = $conn->query($query);
                                         ...
                                         <div class="row">
                                            ...
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                ...
                                                if (
                                                    ...
                                                    $totalLeaveDaysQuery = "SELECT SUM(number_of_days) AS total_leave_days FROM leave_applications_officers WHERE officer_number = '$officer_number'";
                                                            ...
                                                            if ($stmt->execute()) {
                                                                ...
                                                                Swal.fire({
                                                                    ...
                                                                    if (result.isConfirmed) {
                                                                        window.location.href = 'so1_apply_leave.php';
                                                                        }
                                                                    });
                                                                </script>";
                                                            } else {
