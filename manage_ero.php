                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Manage External Research Officers</h3>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-primary">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Manage External Research Officers</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class='table' id="table1">
                                <thead>
                                    <tr>
                                        <th>External Research Officers ID</th>
                                        <th>Full Name</th>
                                        <th>Wing</th>
                                        <th>Action</th>
                                    </tr>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM external_research_officer";
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . $row["name_in_full"] . "</td>";
                                            echo "<td>" . $row["wing"] . "</td>";
                                            echo "<td>
                                                    <div class='action-buttons' style='display: flex; gap: 10px;'>
                                                        <a href='update_external_info.php?id=" .$row['external_id'] ." 'class='btn btn-primary'> Update </a>
                                                        <form id='deleteForm_" . $row["external_id"] . "' method='post' action='delete_ero.php'>
                                                            <input type='hidden' name='external_id' value='" . $row["external_id"] . "'>
                                                            <button type='button' onclick='confirmDelete(" . $row["external_id"] . ")' class='delete-button btn btn-danger'>Delete</button>
                                                        </form>
                                                    </div>
