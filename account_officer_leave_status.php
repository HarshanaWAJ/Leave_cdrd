<?php
    session_start();
        ...
        function determine( $status2, $status3) {
            if ( $status3 == 'approve') {
                return 'approve';
            } elseif ($status3 == 'decline' || $status2 == 'decline') {
                return 'decline';
            } 
            else {
        ...
        function overroll($status2, $status3) {
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>";
                                                $dg = determine( $row['status2'], $row['status3']);
                                                switch ($dg) {
                                                    case 'approve':
                                                        echo "<button class='btn btn-success fixed-width-button'>Approved</button>";
                                                        break;
                                                ...
                                                echo "<td>";
                                                $overroll = overroll( $row['status2'], $row['status3']);
                                                switch ($overroll) {
                                                    case 'approve':
                                                        echo "<button class='btn btn-success fixed-width-button'>Approved</button>";
                                                        break;
