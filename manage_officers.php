                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Officers</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>
                                                ...
                                                <a href='view_officer.php?id=" .$row['id'] ." 'class='btn btn-info'> View </a>
                                                    <a href='update_officer.php?id=" .$row['id'] ." 'class='btn btn-primary'> Update </a>
                                                    <form id='deleteForm_" . $row["id"] . "' method='post' action='delete_officer.php'>
...
<!-- <script>
    function confirmDelete(officerId) {
        var userConfirmed = confirm("Are you sure you want to delete this officer?");
        ...
        if (userConfirmed) {
            ...
            // If user clicks "No," do nothing or add additional handling as needed
        }
    }
</script> -->
<script>
